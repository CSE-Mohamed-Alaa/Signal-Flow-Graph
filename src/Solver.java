...
public class Solver {
    ...
    String getSteps(String result) {
        StringBuilder sb = new StringBuilder();
        sb.append("Over All Gain = " + result + "\n");
        sb.append("------------------------------\n");
        List<List<Integer>> f = getForwardPathList();
        List<List<Integer>> l = getLoopsList();

        sb.append("Forward Pathes\n");
        ...
        sb.append("------------------------------\n");
        sb.append("Delta = " + getDeltaD() + "\n");
        sb.append("------------------------------\n");
        double[] deltaN = getDeltaN();
        for (int i = 0; i < deltaN.length; i++) {
            sb.append("Delta" + i + " = " + deltaN[i] + "\n");
        }
        return sb.toString();
    }
